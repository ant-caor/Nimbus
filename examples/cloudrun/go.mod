module github.com/ant-caor/nimbus/examples/cloudrun
...
replace github.com/ant-caor/nimbus/invalidation/gcppubsub => ../../invalidation/gcppubsub

replace github.com/ant-caor/nimbus/metrics => ../../metrics
